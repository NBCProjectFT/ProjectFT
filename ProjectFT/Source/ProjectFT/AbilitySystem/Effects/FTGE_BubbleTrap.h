 ...
 *  - Duration          : 자동 해제 타이머(SetByCaller Data.BubbleDuration으로 주입).
 *  - GrantedTags       : State.Debuff.Bubble(식별) + State.Debuff.Immobilized(이동정지·차단) + State.Debuff.Escapable(연타 탈출).
